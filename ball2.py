...
BallOne = BouncingBall(350, 250, x_speed, y_speed, 30)
BallTwo = BouncingBall(300, 200, x_speed, y_speed, 30)
BallThree = BouncingBall(400, 300, x_speed, y_speed, 30)
BallFour = BouncingBall(450, 350, x_speed, y_speed, 30)
BallList = [BallOne, BallTwo, BallThree, BallFour]
...
while not done:
    ...
    for elem in BallList:
        elem.flashBounce(screen, RED, SCREEN_WIDTH, SCREEN_HEIGHT)
